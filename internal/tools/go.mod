module github.com/rafpe/kubernetes-podcertificate-signer/internal/tools
...
require (
	...
	k8s.io/cli-runtime v0.37.0-alpha.0 // indirect
	...
	k8s.io/kubectl v0.37.0-alpha.0 // indirect
